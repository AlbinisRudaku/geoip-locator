...
var ipURL = `https://geo.ipify.org/api/v1?apiKey=at_c79WLBmibOGfLZetDPFIy3FJvUdoA&ipAddress=`;
...
searchBtn.addEventListener("click", function () {
  ...
  ipURL = `https://geo.ipify.org/api/v1?apiKey=at_c79WLBmibOGfLZetDPFIy3FJvUdoA&ipAddress=${searchValue}`;
  fetchAPI(ipURL);
});
